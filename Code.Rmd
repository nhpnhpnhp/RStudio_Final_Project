...
worldometer <- read_csv("worldometer_data.csv")
...
```
🔍 Cách đọc biểu đồ Violin Plot:
1. Trục hoành (X-axis):
Gồm các khu vực của Tổ chức Y tế Thế giới (WHO Region): Africa, Americas, Eastern Mediterranean, Europe, South-East Asia, Western Pacific.

2. Trục tung (Y-axis):
Biểu thị tỷ lệ tử vong (%) = (Deaths / Confirmed) × 100 của từng quốc gia thuộc mỗi khu vực.

3. Hình dáng "Violin":
Hình dạng của mỗi violin biểu thị mật độ phân phối của dữ liệu:

Chỗ phình to: Nơi có nhiều quốc gia có tỷ lệ tử vong ở mức đó.

Chỗ hẹp lại: Ít quốc gia có tỷ lệ tử vong tại mức đó.

4. Các chấm đen (jitter):
Mỗi chấm là dữ liệu của một quốc gia. Chúng thể hiện các giá trị thực tế.

Nhờ vậy bạn có thể vừa thấy phân bố mật độ, vừa thấy các giá trị cụ thể.

📊 Phân tích ví dụ từ biểu đồ:
Africa: Phân phối lệch phải (right-skewed), nhiều quốc gia có tỷ lệ tử vong thấp (~1–2%), một số quốc gia có giá trị cao hơn ~7–8%.

Europe: Trải rộng hơn, có vẻ như tỷ lệ tử vong phân bố từ khoảng 1% đến hơn 7%, mật độ dày hơn ở khoảng giữa.

Western Pacific: Phân phối khá hẹp, nhiều quốc gia có tỷ lệ tử vong rất thấp.

Eastern Mediterranean và Americas: Tỷ lệ tử vong đa dạng và có mật độ phân phối đều ở nhiều mức.

South-East Asia: Có tỷ lệ tử vong nhìn chung khá thấp.

✅ 2. Diễn giải kết quả kiểm định ANOVA
Sau khi chạy ANOVA bằng aov(Mortality_Rate ~ WHO Region, data = anova_data):

Kết quả bạn sẽ quan tâm:
p-value (Pr(>F)): Đây là giá trị then chốt để đánh giá sự khác biệt.

Diễn giải:
Nếu p-value < 0.05: Có ý nghĩa thống kê ⇒ ít nhất một khu vực có tỷ lệ tử vong trung bình khác biệt so với phần còn lại.

Nếu p-value ≥ 0.05: Không có bằng chứng đủ mạnh để kết luận sự khác biệt đáng kể.
...
recovery_rate <- calculate_recovery_rate(data, "2020-01-22", "2020-0303-22")
